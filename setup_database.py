...
def create_database():
    ...
    if os.path.exists(DATABASE_FILE):
        ...
        print(f"File database lama '{DATABASE_FILE}' dihapus.")

    conn = sqlite3.connect(DATABASE_FILE)
    cursor = conn.cursor()
    print("Database berhasil dibuat dan terhubung.")
    ...
    # --- Data Awal: Peralatan Konvensional ---
